## Sample Screenshots:
### Screenshot of Excel File before running this GH Action.
COLUMN A-G
![A-G](./docs/images/a-g.png)

COLUMN H-O
![H-O](./docs/images/h-o.png)
...
### Screenshots of excel-ado-sync branch 
![image](https://user-images.githubusercontent.com/86745613/182431328-4268da67-a2d8-400d-84ce-5319053a9df8.png)

### Screeshots of Features autopopulated with ADO Test Case ID as Tag (in excel-ado-sync branch )
